...
unionRoutes.put('/', tokenAuth, (req, res) => {
  Union.query({ orderBy: ['id', 'asc'] }).fetch()
    .then((union) => {
      union.save({
        title: req.body.title || union.get('title'),
        description: req.body.description || union.get('description'),
        url: req.body.url || union.get('url'),
        profile_picture_url: req.body.profile_picture_url || union.get('profile_picture_url'),
        cover_image_url: req.body.cover_image_url || union.get('cover_image_url'),
        ...
        google_analytics_id: req.body.google_analytics_id || union.get('google_analytics_id'),
